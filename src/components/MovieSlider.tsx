      ...
      <Carousel>
        {data.map((movie) => (
            <Carousel.Item key={movie.id}>
              ...
              />
              <div
                className="absolute inset-0 flex flex-col justify-leftr items-left text-left px-8 pt-80 bg-black
              bg-opacity-50 text-[#ffffffac]"
              >
                <h5 className="text-18xl font-bold mb-4 space tracking-wide">
